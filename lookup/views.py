...
def home(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get('http://www.airnowapi.org/aq/forecast/zipCode/?format=application/json&zipCode=' + zipcode + '&distance=25&API_KEY=44844774-5EA7-40CB-92F9-70102CB42D42')
		...
		api_request = requests.get('http://www.airnowapi.org/aq/forecast/zipCode/?format=application/json&zipCode=20002&date=2020-01-19&distance=25&API_KEY=44844774-5EA7-40CB-92F9-70102CB42D42')
